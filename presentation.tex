...
\begin{frame}{Style and Content in Language}
	...
	\begin{table}[ht]
		...
		\begin{tabular}{ l  c | c | c | c | c |}
			...
			\cline{3-6}
			I love this movie & $\rightarrow$ & $0.68$ & $0.12$ & $0.33$ & {\color{red}$0.98$} \\
			\cline{3-6}
			I hate this movie & $\rightarrow$ & $0.68$ & $0.12$ & $0.33$ & {\color{red}$0.03$} \\
			\cline{3-6}
		\end{tabular}
	\end{table}
\end{frame}
...
\begin{frame}{Sequence Autoencoder - Deterministic}
	...
	\end{equation}
	where $h_0 = [s; c]$ is the final hidden state of the encoder.

	Trained using a \textbf{sequence cross-entropy loss}, i.e. the average cross-entropy per time-step.
	\begin{equation*}
...
\begin{frame}{Style Discriminator}
	...
	The adversarial loss that the autoencoder tries to maximize is the Shannon entropy of the predicted distribution $y$.
	\begin{equation}
...
\begin{frame}{Content Discriminator}
	...
	\textbf{Adversarial Loss:}
	The adversarial loss that the autoencoder tries to maximize is the Shannon entropy of the predicted distribution $b$.
	\begin{equation}
